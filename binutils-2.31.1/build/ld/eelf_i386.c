  ...
  if (! initialized)
    {
      ...
      tmppath = concat (ld_sysroot, "/home/majiahao/bbbbb/step3/binutils-install/etc/ld.so.conf",
			(const char *) NULL);
...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/home/majiahao/bbbbb/step3/binutils-install/i386-pc-linux-gnu/lib32\"); SEARCH_DIR(\"/home/majiahao/bbbbb/step3/binutils-install/x86_64-pc-linux-gnu/lib32\"); SEARCH_DIR(\"/home/majiahao/bbbbb/step3/binutils-install/lib32\"); SEARCH_DIR(\"/usr/local/lib32\"); SEARCH_DIR(\"/lib32\"); SEARCH_DIR(\"/usr/lib32\"); SEARCH_DIR(\"/home/majiahao/bbbbb/step3/binutils-install/i386-pc-linux-gnu/lib\"); SEARCH_DIR(\"/home/majiahao/bbbbb/step3/binutils-install/lib\"); SEARCH_DIR(\"/usr/local/lib\"); SEARCH_DIR(\"/lib\"); SEARCH_DIR(\"/usr/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
