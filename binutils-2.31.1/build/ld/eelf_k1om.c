...
OUTPUT_ARCH(k1om)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"/home/majiahao/bbbbb/step3/binutils-install/x86_64-pc-linux-gnu/lib\"); SEARCH_DIR(\"/home/majiahao/bbbbb/step3/binutils-install/lib\"); SEARCH_DIR(\"/usr/local/lib\"); SEARCH_DIR(\"/lib\"); SEARCH_DIR(\"/usr/lib\");\n\
SECTIONS\n\
{\n\
  /* Read-only sections, merged into text segment: */\n\
